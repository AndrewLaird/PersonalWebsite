...
<div class='page'>
    ...
    <div class="polaroid">
     <div class="caption">
        <p>Google Irvine's Tech Challege
        </br>This was a fanastic oportuniy, Google invited teams of college students to compete over tiny challenges, some programming, some logic puzzles, some that required pop culture knowledge. It was a day of fun and solving problems that you would really only hear about in books. Out team solved the most challenges and won the competition but the real reward was just being in that room and having fun being computer science students  </p>
      </div>
    ...
    <div class="polaroid">
     <div class="caption">
        <p>INRF:
        </br>My first year at UCI I was incredibly fortunate to find a lab that needed fullstack work done and had the pacients to teach me. I worked with one software developer and a lab full of engineers to provide meaningful information. Technicians would create circuits in this lab and the process of doing that is very inconsistent. To help them understand why their experimetns were failing, I built a sytem that measured the climate in the lab at any particular moment. So they could look back and see if the lab spiked out of reasonable conditions during their experiment. One of the best parts of this project was the lack of direction, we had a final goal but other than that, I was given a budget and blank desktop computer. So I installed linux on the computer and went to work making a network of raspbery pi's to measure the climate and report it to the main server. From there I made the API public and a more senior engineer took that data and integrated it into the interface you see below. The second picture is the raspberry pi's before they were installed</p>
      </div>
